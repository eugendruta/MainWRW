$(document).ready(function () {
  dialogname = 'webrw'
  UTIL.logger(
    dialogname + ': ready(): Start; startdialog: ' + globalconfig.startdialog
  )
  ...
  function onStorageEvent (storageEvent) {
    ...
    if (newvalue === 'closed') {
      ...
      var newWin = window.open(
        'http://' + feserver + '/' +
        aktdialog.substring(0, 1).toUpperCase() +
        aktdialog.substring(1, aktdialog.length) + 'WRW/' +
        aktdialog + '/' + aktdialog + '.html', '_blank')
